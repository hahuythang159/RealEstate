        ...
        <Layout style={{ minHeight: '100vh' }}>
            <Sider width={200} className="site-layout-background"collapsible collapsed={collapsed} onCollapse={setCollapsed}>
                ...
                <Menu mode="inline" style={{ height: '100%', borderRight: 0 }}>
                    <Menu.Item key="1" icon={<HeartOutlined/>} onClick={()=>navigate('/tanant/favorites')}>
                        Danh sách yêu thích
                    </Menu.Item>
                    <Menu.Item key="2" icon={<FileSyncOutlined/>} onClick={()=>navigate('/tanant/approval')}>
                        Danh sách hợp đồng
                    </Menu.Item>
                    <Menu.Item key="3" icon={<FileProtectOutlined/>} onClick={()=>navigate('/tanant/approved')}>
                        Hợp đồng đã duyệt
                    </Menu.Item>
                    <Menu.Item key="4" icon={<UserOutlined />} onClick={() => navigate('/tanant/profile')}>
                        Hồ sơ của tôi
                    </Menu.Item>
                    </Menu>
            </Sider>
